...
class ReceiptDetailedPage extends StatefulWidget {
  const ReceiptDetailedPage(
      {super.key, required this.clientId,required this.receiptId, required this.clientName});
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('clients')
              .doc(widget.clientId)
              .collection('receipts').doc(widget.receiptId)
              .snapshots(),
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) =>
                                ...
                                date: data['dof3a'][index]
                                    ['date'],
                                price: data['dof3a'][index]
                                    ['price'],
                                way: data['dof3a'][index]
                                    ['way'],
                              ),
                            ),
                            Padding(
