...
class _VisitsCreatePageState extends State<VisitsCreatePage> {
        ...
        child: Column(
         ...
         _showDatePicker(context)
            ...
            FatoraButton(
                            ...
                            ontap: ()async {
            if (clientCont.text.isNotEmpty&& dateCont.text.isNotEmpty&&visitReasonCont.text.isNotEmpty&&visitType.isNotEmpty) {
  ...
  final documentSnapshot = await existingDocumentRef.get();
    ...
    final fieldValue = documentSnapshot.data()!['visits']; 
              ...
              await FirebaseFirestore.instance.collection('vars').doc('id').update({'visits':FieldValue.increment(1)});
